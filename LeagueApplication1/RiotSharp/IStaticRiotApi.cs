...
namespace RiotSharp
{
    ...
    {
        ChampionListStatic GetChampions(Region region, List<ChampionData> championData,
        ...
        Task<ChampionStatic> GetChampionAsync(Region region, int championId,
            List<ChampionData> championData, Language language = Language.en_US);
        ItemListStatic GetItems(Region region, List<ItemData> itemData,
            Language language = Language.en_US);
        Task<ItemListStatic> GetItemsAsync(Region region, List<ItemData> itemData,
            Language language = Language.en_US);
        ItemStatic GetItem(Region region, int itemId, List<ItemData> itemData,
            Language language = Language.en_US);
        Task<ItemStatic> GetItemAsync(Region region, int itemId, List<ItemData> itemData,
            Language language = Language.en_US);
