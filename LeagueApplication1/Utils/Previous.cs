...
namespace LeagueApplication1
{
	public class Previous
	{
		...
		public Previous(string champPlayed, int level, bool result, string gold, string creepScore, List<UriImageSource> itemNameList,
		List<UriImageSource> summonerSpellList, UriImageSource imagePath, string dateTime = "", string gameMode = "", Game thisGame = null)
		{
			ThisGame = thisGame;
			Name = champPlayed;
			Title = gameMode;
